...
function animateSplash(index){
  ...
  //console.log('animateDownSlowDown', obj, next_obj)
  animateFadeIn(img, 0, 138, img);
  setTimeout(function(){ animateInfoBtn(index) }, 800);
}
