...
// FLOATS
  ...
  jQuery(document).ready(function($) {
      ...
      function ScaleSlider() {
          ...
          if (parentWidth)
              jssor_slider.$ScaleWidth(Math.max(Math.min(parentWidth, 930), 200));
          else
      ...
      function SlideshowEndEventHandler(slideIndex, progressBegin, slideshowBegin, slideshowEnd, progressEnd) {
        ...
        jssor_slider.$On($JssorSlider$.$EVT_SLIDESHOW_END, SlideshowEndEventHandler);
...
, color: '#ee2d26' // #rgb or #rrggbb or array of colors
...
function percentCounter(){
 /* var counter = 0;  
  $('#loading_line').animate({
      ...
      , step: function(now) {
          ++counter;         
          var datapos = Math.abs(counter/3) | 0
          datapos = Math.min(datapos, 99);
          $('#loading_percent').html(datapos + '%');
      }
  });*/
...
$(".slider")
   ...
   $("#custom-labels-slider-result").text(discounts[ui.value] );
